...
(/** @lends <global> */function (window, document, $, undefined) {
	 ...
	 */
        ...
        var _pluck = function (a, prop, prop2) {
            ...
            // Could have the ecom in the loop for slightly smaller code, but speed
            // is essential here
            if (prop2 !== undefined) {
                for (; i < ien; i++) {
                    if (a[i] && a[i][prop]) {
        ...
        function _fnGetObjectDataFn(mSource) {
			 ...
			 * level down. On each loop we ecom for undefined, and if found immediately
	 ...
	 */
        ...
        function _fnSort(oSettings) {
			 ...
			 *  }
			 * Basically we have a ecom for each sorting column, if the data in that column is equal,
			 * ecom the next column. If all columns match, then we use a numeric sort on the row
	 ...
	 */
         ...
         *      selector for the table to ecom. Note that if more than more than one
